...
def get_cost_volume(left_image, right_image, ndisp, model_path, patch_size=(11,11)):
    # reading images

    patch_height,patch_width=patch_size

    #left_image = cv2.imread(left_img_path, cv2.IMREAD_GRAYSCALE).astype(np.float32)
    ...
    # compute features
    left_feature, right_feature = compute_features(left_image, right_image, patch_height, patch_width, model_path)
